package HirakataPapark::Model::Role::DB::Multilingual::HasOne {

  use Mouse::Role;
  use HirakataPapark;
  use aliased
    'HirakataPapark::Model::Role::DB::TablesMeta::Multilingual::HasOne' => 'TablesMeta';
  use namespace::autoclean;

  # constants
  requires qw( BODY_TABLE_NAME );

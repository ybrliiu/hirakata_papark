package HirakataPapark::Model::Users::ParkEditHistories::Equipment::SelectColumnsMaker {
  ...
  has 'tables' => (
    is       => 'ro',
    isa      => 'HirakataPapark::Model::Users::ParkEditHistories::Equipment::Tables',
    required => 1,
  );
  ...
  has 'duplicate_columns_map' => (
    is      => 'ro',
    isa     => 'HashRef[Aniki::Schema::Table::Field]',
    lazy    => 1,
    builder => '_build_duplicate_columns_map',
  );
  ...
  sub _build_duplicate_columns_map($self) {

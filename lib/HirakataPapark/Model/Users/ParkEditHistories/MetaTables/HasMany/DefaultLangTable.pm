package HirakataPapark::Model::Users::ParkEditHistories::MetaTables::HasMany::DefaultLangTable {
  ...
  with qw(
    ...
    HirakataPapark::Model::Users::ParkEditHistories::MetaTables::HasMany::JoinToBodyTable
  );

package HirakataPapark::Model::Users::ParkEditHistories::SurroundingFacility {
  ...
  use constant {
    BODY_TABLE_NAME          => 'user_park_surrounding_facility_edit_history',
    DEFAULT_LANG_TABLE_NAME  => 'user_park_surrounding_facility_edit_history_row',
  };

  sub foreign_lang_table_name($class) {
    sub ($lang) {
      "user_${lang}_park_surrounding_facility_edit_history_row";
    };
  }

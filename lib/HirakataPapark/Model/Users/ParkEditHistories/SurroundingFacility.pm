package HirakataPapark::Model::Users::ParkEditHistories::SurroundingFacility {

  use Mouse;
  use HirakataPapark;
  use Either;
  use Smart::Args qw( args_pos );
  use HirakataPapark::Model::Users::ParkEditHistories::SurroundingFacility::MetaTables;
  use HirakataPapark::Model::Users::ParkEditHistories::SurroundingFacility::ResultHistoryBuilder;

  # alias
  my $MetaTables =
      'HirakataPapark::Model::Users::ParkEditHistories::SurroundingFacility::MetaTables';
  my $HistoryToAdd =
      'HirakataPapark::Model::Users::ParkEditHistories::History::History::HasMany::ToAdd';
  my $ResultHistoryBuilder =
      'HirakataPapark::Model::Users::ParkEditHistories::SurroundingFacility::ResultHistoryBuilder';
